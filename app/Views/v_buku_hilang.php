            ...
            <table id="example2" class="table table-bordered table-hover">
                <thead>
                    <tr class="text-center">
                        <th width="50px">No</th>
                        <th>ID Anggota yang menghilangkan</th>
                        <th>Kelas</th>
                        <th>Judul Buku</th>
                        <th>No Buku</th>
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-warning btn-flat btn-sm" data-toggle="modal"
                                data-target="#modal-edit<?= $value['id_hilang'] ?>">
                                <i class="fas fa-edit"> </i>
                            </button>
                            <button type="button" class="btn btn-danger btn-flat btn-sm" data-toggle="modal"
                                data-target="#modal-delete<?= $value['id_hilang'] ?>">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select name="id_anggota" class="form-control select2" placeholder="ID Anggota">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select name="id_buku" class="form-control select2" placeholder="Judul Buku">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>ID Anggota yang menghilangkan</label>
                            <input type="text" class="form-control" value="<?= $value['id_anggota'] ?>"
                                name="id_anggota" placeholder="id_anggota" required>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>No Buku</label>
                            <input type="text" class="form-control" value="<?= $value['no_buku'] ?>" name="no_buku"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>Kelas</label>
                            <select name="id_kelas" class="form-control select2" placeholder="Kelas" required>
                                <option value="">Pilih Kelas</option>
                                <?php foreach ($kelas as $kelas_item) { ?>
                                <option value="<?= $kelas_item['nama_kelas'] ?>"
                                    <?= ($kelas_item['nama_kelas'] == $value['id_kelas']) ? 'selected' : '' ?>>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>Judul Buku</label>
                            <select name="id_buku" class="form-control select2" placeholder="Judul Buku" required>
                                <option value="">Pilih Buku</option>
                                <?php foreach ($buku as $buku_item) { ?>
                                <option value="<?= $buku_item['id_buku'] ?>"
                                    <?= ($buku_item['id_buku'] == $value['id_buku']) ? 'selected' : '' ?>>
