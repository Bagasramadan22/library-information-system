...
<div class="row" >
    ...
    <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-white">
            ...
            <a href="<?= base_url('Anggota/Lapanggota') ?>" class="small-box-footer">Cetak <i class="fas fa-arrow-circle-right"></i></a>
        </div>
    </div>
    <div class="col-lg-3 col-6">
        <!-- small box -->
        <div class="small-box bg-white">
            ...
            <a href="<?= base_url('Buku/Lapbuku') ?>" class="small-box-footer">Cetak <i class="fas fa-arrow-circle-right"></i></a>
        </div>
    </div>
</div>
</div>
