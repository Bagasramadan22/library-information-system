...
<body>
    ...
    function updateDateTime() {
        ...
        document.getElementById('namaHari').textContent = namaHari;
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="<?= base_url('slide/Header Sekolah.png') ?>" alt="First slide">
            </div>
        </div>
...
<div class="col-md-12">
    <div class="card card-outline card-primary">
        ...
        <div class="card-header">
            <div class="row">
                <div class="col-sm-12 ">
                    <h3 class="card-title">Buku yang ada diperpustakaan SMP Nurul Anwar Kota Bekasi</h3>
                    <!-- </div>
            <div class="col-sm-12">
            ...
            <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                    ...
                    foreach ($buku as $key => $value) { ?>
                        <tr>
                            <td><?= $no++ ?>.</td>
                            <td class="text-center"><img src="<?= base_url('cover/' . $value['cover']) ?>" width="80px"
                                    height="80px"></td>
                            <td>
                            ...
                            <td><?= $value['tahun'] ?></td>
                            <td><?= $value['bahasa'] ?></td>
                            <td class="text-center"><span class="badge badge-success"><?= $value['jumlah'] ?></span>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
