    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open(base_url('Denda1/Add')) ?>
                <div class="row">
                    <div class="col-sm-6">
...
<div class="modal fade" id="modal-edit<?= $value['id_denda'] ?>">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open(base_url('Denda1/UpdateData/' . $value['id_denda'])) ?>
                <div class="form-group">
                    <label>Tanggal</label>
...
<div class="modal fade" id="modal-delete<?= $value['id_denda'] ?>">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open(base_url('Denda1/DeleteData/' . $value['id_denda'])) ?>
                <div class="form-group">
