...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a class="brand-link">
                <img src="<?= base_url('template') ?>/dist/img/logo1.jpg" alt="AdminLTE Logo"
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="<?= base_url('template') ?>/dist/img/user.jpg" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
                        <a class="d-block">Kepsek</a>
                    </div>
                </div>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('Peminjaman/Laporantrans2') ?>"
        ...
        <div class="content-wrapper">
            <!-- ubah warna disiko koding nyo : style="background-color: greenyellow;" -->
