...
<div class="modal fade" id="modal-edit<?= $value['id_kelas'] ?>">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open(base_url('Kelas/UpdateData/'. $value['id_kelas'] )) ?>
                <div class="form-group">
                    <label>Nama Kelas</label>
                    <input type="text" class="form-control" value="<?= $value['nama_kelas'] ?>" name="nama_kelas" placeholder="Nama Kelas" required>
                </div>
            </div>
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-default btn-flat" data-dismiss="modal">Batal</button>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        Yakin Hapus Data  <b><?= $value['nama_kelas'] ?></b> ?
