    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open(base_url('Hilang1/Add')) ?>
                <div class="row">

                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>ID Anggota</label>
                            <select name="id_anggota" class="form-control select2" placeholder="Kelas">
...
<div class="modal fade" id="modal-edit<?= $value['id_hilang'] ?>">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open(base_url('Hilang1/UpdateData/' . $value['id_hilang'])) ?>
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="<?= $value['id_anggota'] ?>"
                                name="id_anggota" placeholder="Nama" required>
                        </div>
                    </div>
...
<div class="modal fade" id="modal-delete<?= $value['id_hilang'] ?>">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open(base_url('Hilang1/DeleteData/' . $value['id_hilang'])) ?>
                <div class="form-group">
