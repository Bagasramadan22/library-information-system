...
<body class="hold-transition layout-top-nav">
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
            <div class="container">
                <a class="navbar-brand">
                    ...
                    <span class="brand-text font-weight-light"><b>Sistem Informasi Perpustakaan SMP Nurul Anwar Kota
                            Bekasi</b></span>
                </a>
                <!-- Right navbar links -->
                <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li><a href="<?= base_url('Home/Aturan') ?>" class="dropdown-item">Aturan dan Ketentuan
                                    Perpustakaan</a></li>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; <a>SMP Nurul Anwar</a>.</strong>
        </footer>
    </div>
    <!-- ./wrapper -->
