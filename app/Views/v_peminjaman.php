                    ...
                    <?php foreach ($peminjaman as $key => $value) : ?>
                        <?php if ($value['status'] == 'Pinjam') : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('Peminjaman/VerifikasiPengembalian/' . $value['id_pinjam']) ?>" class="btn btn-warning btn-flat btn-sm">
                                        <i class="fas fa-solid fa-check"></i>
                                    </a>
                                    <button type="button" class="btn btn-danger btn-flat btn-sm" data-toggle="modal" data-target="#modal-delete<?= $value['id_pinjam'] ?>">
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                $tgl = date('d F Y');
                ?>
                <?php echo form_open(base_url('Peminjaman/Add')) ?>
                <div class="row">
                    <div class="col-sm-12">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label>Tanggal Harus Dikembalikan</label>
                            <input type="date" class="form-control" name="tgl_harus_kembali" >
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
