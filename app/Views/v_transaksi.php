            ...
            <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <!-- <td><span class="badge badge-success"><= $value['status_kembali'] ?></span></td> -->
                        <td>
                            <span
                                class="badge <?= isset($value['status_kembali']) && $value['status_kembali'] == 'Terlambat' ? 'badge-danger' : 'badge-success' ?>">
                                <?= isset($value['status_kembali']) ? $value['status_kembali'] : 'Tidak terlambat' ?>
                            </span>
                        </td>
                        ...
                        <td>
                            <button type="button" class="btn btn-danger btn-flat btn-sm" data-toggle="modal"
                                data-target="#modal-delete<?= $value['id_pinjam'] ?>">
